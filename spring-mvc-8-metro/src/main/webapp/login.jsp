...
<body>
    ...
    <form>
        ...
        <input type="text" id="loginID" name="loginID" onblur="">
        </div>
        <div id="usernameError" class="error">Enter valid login id</div>

        <div class="fields">
        <label for="password">Password:</label>
        <input type="password" id="password" name="password" onblur="">
        </div>
        <div id="usernameError" class="error">Enter valid password</div>
